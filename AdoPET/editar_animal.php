...
if (!isset($_SESSION['user_id'])) {
    set_flash_message('Fa�a login para editar um animal.', 'warning');
...
if (!$animal) {
    set_flash_message('Animal n�o encontrado ou voc� n�o tem permiss�o para edit�-lo.', 'danger');
    header('Location: dashboard.php');
    exit();
}
...
<section class="form-section">
    ...
    <form method="POST" action="editar_animal.php?id=<?php echo $animal['id']; ?>" enctype="multipart/form-data">
        ...
        <div class="checkbox-group">
            ...
            <label><input type="checkbox" name="disponivel" <?php if($animal['disponivel']) echo 'checked'; ?>> Dispon�vel para Ado��o</label>
        </div>

        <label for="descricao">Descri��o e Personalidade:</label>
