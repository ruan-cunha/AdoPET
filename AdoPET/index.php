...
$page_title = 'Seu Novo Melhor Amigo Espera Por Voc�!';
...
try {
    ...
    $_SESSION['flash_message'] = ['message' => 'N�o foi poss�vel carregar os dados da p�gina inicial.', 'type' => 'danger'];
}
$conn->close();
...
<section class="hero">
    <div class="hero-content">
        ...
        <p>Milhares de animais resgatados esperam por um lar cheio de carinho e seguran�a. D� uma segunda chance, adote!</p>
        <a href="animais.php" class="btn-primary">Ver Animais Dispon�veis</a>
    </div>
</section>

<section class="container section-padding how-it-works">
    <h2 class="section-heading">Adotar � Simples!</h2>
    <p class="section-subheading">Em apenas 3 passos, voc� pode mudar uma vida para sempre.</p>
    <div class="steps-grid">
        <div class="step-item">
            <div class="step-icon"><i class="fas fa-search"></i></div>
            <div class="step-number">1</div>
            <h3>Explore e Encontre</h3>
            <p>Navegue pelos perfis de c�es e gatos. Use nossos filtros para achar o pet com a sua vibe!</p>
        </div>
        <div class="step-item">
            <div class="step-icon"><i class="fas fa-heart"></i></div>
            <div class="step-number">2</div>
            <h3>Manifeste Interesse</h3>
            <p>Achou seu futuro amigo? Preencha um formul�rio simples para o doador conhecer um pouco sobre voc�.</p>
        </div>
        <div class="step-item">
            <div class="step-icon"><i class="fas fa-home"></i></div>
            <div class="step-number">3</div>
            <h3>Prepare o Lar</h3>
            <p>Ap�s a aprova��o, combine a entrega e prepare sua casa para receber o mais novo membro da fam�lia!</p>
        </div>
    </div>
</section>
...
<section class="bg-light-purple section-padding">
    <div class="container">
        ...
        <p class="section-subheading">Essas fofuras est�o ansiosas por um sof� pra chamar de seu. Veja se n�o rola um match!</p>
        <div class="galeria-animais">
            <?php if (!empty($animais_destaque)): ?>
                ...
                <?php endforeach; ?>
            <?php else: ?>
                <p class="info-message text-center">Nenhum animal em destaque no momento. <a href="animais.php">Veja todos os animais dispon�veis!</a></p>
            <?php endif; ?>
        </div>
...
<section class="stats-section section-padding">
    <div class="container">
        <h2 class="section-heading light-text">Nossa Causa em N�meros</h2>
        <div class="stats-grid">
            ...
            <div class="stat-item">
                ...
                <p class="stat-label">Fam�lias Felizes</p>
            </div>
            <div class="stat-item">
