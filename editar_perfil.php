...
<section class="form-section">
    ...
    <form method="POST" action="editar_perfil.php">
        ...
        <input type="text" id="telefone" name="telefone" value="<?php echo htmlspecialchars($usuario['telefone'] ?? ''); ?>" placeholder="Ex: (47) 98888-7777">
        <small class="help-text">Apenas números, com DDD.</small>

        <?php if ($usuario['tipo_usuario'] == 'ONG'): ?>
            <label for="descricao">Descriçãoo da ONG:</label>
